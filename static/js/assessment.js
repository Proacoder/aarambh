...
function renderQuestion(index) {
  ...
  // Trigger smooth card slide-in
  container.classList.remove('quiz-card-enter');
  void container.offsetWidth;
  container.classList.add('quiz-card-enter');
...
function showCelebrationModal() {
  ...
  overlay.innerHTML = `
    <div class="celebration-box">
      ...
      <h2 style="font-size:1.6rem; font-weight:800; color:var(--earth-brown); margin-bottom:0.5rem;">Assessment Complete!</h2>
      <p style="color:var(--text-muted); font-size:0.95rem; margin-bottom:1.5rem;">AI has calculated your Holland Code & matched top high-growth career tracks in Maharashtra.</p>
      <div class="flex-center">
        <div class="btn btn-gold btn-lg flex align-center gap-2" style="pointer-events:none;">
          <span>Unlocking Career DNA</span> <span class="spinner"></span>
        </div>
      </div>
    </div>
  `;
